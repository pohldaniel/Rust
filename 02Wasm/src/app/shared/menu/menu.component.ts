...
export class MenuComponent implements OnInit{
  ...
  refreshItems(){
    ...
    .set(Math.pow(2, 0), {target : '/web-gpu', description: 'Rust WebGPU', descriptionLineBreak: '', class : 'two-one', index : 0} as MenuItem)
    .set(Math.pow(2, 1), {target : '/rust-ems', description: 'Rust Emscripten', descriptionLineBreak: '', class : 'two-one', index : 1} as MenuItem);
