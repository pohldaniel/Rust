...
use std::ffi::{c_char, c_double, c_float, c_int, c_ulonglong, c_long, c_schar, c_short};
use std::ffi::{c_uchar, c_uint, c_ushort, c_ulong, c_void};
...
pub const khronos_boolean_enum_t_KHRONOS_BOOLEAN_ENUM_FORCE_SIZE: khronos_boolean_enum_t =
    2147483647;
pub type khronos_boolean_enum_t = c_uint;
...
pub type PFNGLGETVERTEXATTRIBPOINTERVPROC = ::core::option::Option<
    unsafe extern "C" fn(index: GLuint, pname: GLenum, pointer: *mut *mut c_void),
>;
...
pub type PFNGLDEBUGMESSAGECALLBACKKHRPROC = ::core::option::Option<
    unsafe extern "C" fn(callback: GLDEBUGPROCKHR, userParam: *const c_void),
>;
...
pub type PFNGLOBJECTPTRLABELKHRPROC = ::core::option::Option<
    unsafe extern "C" fn(ptr: *const c_void, length: GLsizei, label: *const GLchar),
>;
...
pub type PFNGLGETPOINTERVKHRPROC = ::core::option::Option<
    unsafe extern "C" fn(pname: GLenum, params: *mut *mut c_void),
>;
...
pub type PFNGLMAPBUFFEROESPROC = ::core::option::Option<
    unsafe extern "C" fn(target: GLenum, access: GLenum) -> *mut c_void,
>;
...
pub type PFNGLGETBUFFERPOINTERVOESPROC = ::core::option::Option<
    unsafe extern "C" fn(target: GLenum, pname: GLenum, params: *mut *mut c_void),
>;
...
pub type PFNGLIMPORTSEMAPHOREWIN32HANDLEEXTPROC = ::core::option::Option<
    unsafe extern "C" fn(semaphore: GLuint, handleType: GLenum, handle: *mut c_void),
>;
pub type PFNGLIMPORTSEMAPHOREWIN32NAMEEXTPROC = ::core::option::Option<
    unsafe extern "C" fn(semaphore: GLuint, handleType: GLenum, name: *const c_void),
>;
...
pub type PFNGLEXTGETBUFFERPOINTERVQCOMPROC = ::core::option::Option<
    unsafe extern "C" fn(target: GLenum, params: *mut *mut c_void),
>;
